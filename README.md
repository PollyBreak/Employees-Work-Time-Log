...
📌 Attendance Service — это микросервис для учёта рабочего времени сотрудников по email, с поддержкой:
...
- 📱 Учёт посещаемости через email сотрудников (через QR или ссылку)
- 🛡️ Привязка email к браузеру для защиты от подмены
...
- `Вы ушли с работы!`
- `Этот email не зарегистрирован в этой компании. Проверьте введенные данные.`
